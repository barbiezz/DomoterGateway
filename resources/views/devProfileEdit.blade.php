        ...
        <main class="py-4">
                ...
                <div class="card-body">
                    ...
                    @endif
					 ...
					 <form method="POST" action="/deviceProfiles/edited/{{$device_profile[0]->id}}">
   					 @csrf
    					<div class="form-group">
        						<label for="name">Name</label>
        						<input type="text" name="name" class="form-control" value="{{$device_profile[0]->name}}">
                                <p style="color:red;">don't leave blank spaces between words</p>
   					</div>
   					<div class="form-group">
        						<label for="topic">Topic</label>
        						<input type="text" name="topic" class="form-control" value="{{$device_profile[0]->topic}}">
